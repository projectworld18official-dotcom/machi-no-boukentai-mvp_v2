...
export const TitleScreen = ({ goToScreen }: Props) => (
  <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', minHeight:'100dvh', background:'#1a1a2e', gap:48 }}>
    ...
    <button onClick={() => goToScreen('character-create')} style={{ padding:'14px 40px', fontSize:18, background:'transparent', border:'2px solid #f0d080', color:'#f0d080', borderRadius:4, cursor:'pointer', letterSpacing:'0.1em' }}>はじめから</button>
  </div>
);
